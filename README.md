...
In the drop down menu below you can see my projects, newest first (the headings are hyperlinks to repositories, feel free to click).
...
<details>
  ...
  A network monitoring service: asynchronous ICMP and TCP sweeps with a live dashboard over WebSocket — the rewrite of the Kivy version further down this list

  **Tech stack:** Python, FastAPI, WebSocket, SQLAlchemy, SQLite, Pydantic, icmplib, JavaScript, Docker, Pytest
  ...
  **Tech stack:** Python, FastAPI, PostgreSQL, Aiokafka, Asyncpg, Docker, SQLAlchemy, Pydantic
  ...
  A scheduled parser that pulls job postings from the hh.ru API and aggregates their salary ranges

  **Tech stack:** Python, FastAPI, MySQL, SQLAlchemy, APScheduler, HTTPX, Pydantic, Poetry
  ...
  **Tech stack:** Python, FastAPI, PostgreSQL, gRPC, Asyncpg, Docker, Alembic, SQLAlchemy, Pydantic
  ...
  A service that calculates in-game bonuses from uploaded config data
  ...
  **Tech stack:** Python, Pytest, Elasticsearch
  ...
  A Django site that pulls weather forecasts from an API and renders charts from them
  ...
  **Tech stack:** Python, FastAPI, SQLAlchemy, Pydantic, Pytest
  ...
  The first take on network monitoring: a desktop GUI that pings devices on a flexible timer
...
<details>
  ...
  My solutions to 1400+ algorithmic problems

  **Tech stack:** Python

  ### 2️⃣ [AdventOfCode2025](https://github.com/Dopelen/AdventOfCode2025)
  My solutions to problems from the 2025 edition of the annual AdventOfCode event
...
## Here's a checklist to track my progress in life:
...
- [x] [Solve all available free easy algorithmic problems](https://leetcode.com/u/Oleg_Ab/)
...
- [x] Build my cool [***project***](https://github.com/Dopelen/CheckIPer) with a GUI and animations (This project has a [***new***](https://github.com/Dopelen/CheckIPer-new) version!)
...
- [x] Build a service within a microservice architecture, while automating the testing system for the entire project
...
- [x] Find a new job
- [x] Scale the business logic of an ERP platform with 1500+ related tables and tens of millions of rows
- [x] Learn to hunt bottlenecks properly — indexing, partitioning, batching, decomposing oversized tables and rewriting the SQL nobody else wanted to open
- [x] Help migrate a system from JavaScript to Python without breaking a single calculation
- [x] Make the autotest suite run ~80× faster by caching metadata
- [x] Integrate with an external accounting system (SBIS), matching documents on both sides
- [x] Build a notification system driven by trigger events and scheduled mass recalculations
- [x] Ship KPI forecasting calculated from live data
- [x] Pass the 100-production-bug mark — and stop counting
- [ ] Solve all available hard algorithmic problems
...
|760 days of daily LeetCode — still counting, still debugging|
